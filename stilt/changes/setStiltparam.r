...
#  c(   "", "climat",    "TM3",       "",       "",       ""),                                                    #inikind, possible values: "climat" (Gerbig et al. (2003)),
...
#  c("/Net/Groups/BSY/STILT/fluxes_input/TM3x/mu1.0_070_mix_YYYY_fg.b",                                     #(not for "climat") full name for initial & boundary cond. file (CO2)
...
#foottimes <- c(0,10,20,40) # vector of times (backtimes) in hours between which footprint is computed
#foottimes <- c(0,12,24,48,72,96,-nhrs) # vector of times (backtimes) in hours between which footprint is computed
