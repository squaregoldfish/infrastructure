 ...
 * where the left one is one third of the width and the right one is two thirds.
 *
 * Variables:
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> display one-third clearfix">
