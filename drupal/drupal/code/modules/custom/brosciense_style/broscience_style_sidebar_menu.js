(function ($) {
    Drupal.behaviors.broscience_style = {
        attach: function (context, settings) {
            ...
            style_bs_submenu(settings.broscience_style.elementColor, settings.broscience_style.modulePath);
            place_bs_submenu();
...
function style_bs_submenu(elementColor, modulePath) {
    if (jQuery(window).width() > min) {
        ...
        jQuery('#block-menu-block-1 a.active').append('<span style="margin-left: 0.4rem; color: #414042">&#8680;</span>');
